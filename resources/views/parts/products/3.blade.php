...
<div class="product-card flex flex-col rounded-3xl bg-card">
    <a href="product.html" class="product-card-photo overflow-hidden h-[320px] rounded-3xl">
        <img src="./storage/images/products/3.jpg" class="object-cover w-full h-full"
    ...
    <div class="grow flex flex-col py-8 px-6">
        <h3 class="text-sm lg:text-md font-black"><a href="product.html"
                                                     class="inline-block text-white hover:text-pink">Logitech G PRO
                Mechanical Gaming Keyboard RU</a></h3>
        <div class="mt-auto pt-6">
            <div class="mb-3 text-sm font-semibold">51 500 ₽</div>
                ...
                <a href="#" class="w-[56px] !h-[56px] !px-0 btn btn-pink">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor" viewBox="0 0 52 52">
                        <path fill-rule="evenodd"
                              d="M51.38 6.692c.481.442.514 1.19.073 1.67l-33.8 36.873a1.182 1.182 0 0 1-1.707.037L.582 29.908a1.182 1.182 0 1 1 1.672-1.67l14.49 14.49L49.712 6.765a1.182 1.182 0 0 1 1.67-.073Z"
                              clip-rule="evenodd"/>
                    </svg>
                </a>
