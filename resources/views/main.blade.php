                ...
                <div class="grid grid-cols-2 md:grid-cols-3 2xl:grid-cols-6 gap-4 md:gap-8 mt-12">
                    <a href="catalog.html" class="p-6 rounded-xl bg-card hover:bg-card/60">
                        <div class="h-12 md:h-16">
                            <img src="storage/images/brands/1.png" class="object-contain w-full h-full"
                                 alt="Steelseries">
                        </div>
                    ...
                    <a href="catalog.html" class="p-6 rounded-xl bg-card hover:bg-card/60">
                        <div class="h-12 md:h-16">
                            <img src="storage/images/brands/2.png" class="object-contain w-full h-full"
                                 alt="Razer">
                        </div>
                    ...
                    <a href="catalog.html" class="p-6 rounded-xl bg-card hover:bg-card/60">
                        <div class="h-12 md:h-16">
                            <img src="storage/images/brands/3.png" class="object-contain w-full h-full"
                                 alt="Logitech">
                        </div>
                    ...
                    <a href="catalog.html" class="p-6 rounded-xl bg-card hover:bg-card/60">
                        <div class="h-12 md:h-16">
                            <img src="storage/images/brands/4.png" class="object-contain w-full h-full"
                                 alt="HyperX">
                        </div>
                    ...
                    <a href="catalog.html" class="p-6 rounded-xl bg-card hover:bg-card/60">
                        <div class="h-12 md:h-16">
                            <img src="storage/images/brands/5.png" class="object-contain w-full h-full"
                                 alt="Playstation">
                        </div>
                    ...
                    <a href="catalog.html" class="p-6 rounded-xl bg-card hover:bg-card/60">
                        <div class="h-12 md:h-16">
                            <img src="storage/images/brands/6.png" class="object-contain w-full h-full" alt="XBOX">
                        </div>
